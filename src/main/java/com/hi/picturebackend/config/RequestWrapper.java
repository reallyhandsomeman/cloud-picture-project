...
public class RequestWrapper extends HttpServletRequestWrapper {
    ...
    private final String body; // 把字节流存储到body中
    ...
    public RequestWrapper(HttpServletRequest request) {
        ...
        body = stringBuilder.toString(); // 持久化
    }

    @Override
    public ServletInputStream getInputStream() throws IOException {
        final ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(body.getBytes()); // 重新构建流
